...
var ituTT35MpegCCDataFormat decode.Group

func init() {
	interp.RegisterFormat(decode.Format{
		Name:        format.MPEG_ITU_T35,
		Description: "ITU-T.35 closed captioning data",
		Dependencies: []decode.Dependency{
			{Names: []string{format.MPEG_CC_DATA}, Group: &ituTT35MpegCCDataFormat},
		},
...
func mpegItuT35SDecode(d *decode.D, _ any) any {
	...
	case "GA94":
		d.FieldStruct("user_structure", func(d *decode.D) {
			...
			d.FieldFormat("user_data_type_structure", ituTT35MpegCCDataFormat, nil)
		})
	default:
